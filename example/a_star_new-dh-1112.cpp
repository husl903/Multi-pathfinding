    ...
    //   std::cout << "111111111111111111111111--------------------------\n";
      ...
      if (env.stateValid(start)) {
        ...
        if(success){
          ...
          if(success) std::cout <<filename <<  ", success, cost, " << solution.cost <<"," << env.is_roll_fall << ",start, " << startX << ", " << startY << ", goal, " << goalX <<", " << goalY << ", memory, " << r_usage.ru_maxrss  << ",preprocess time 1, "<< preprocess.elapsedSeconds() << ", preprocess2, " << preprocess2.elapsedSeconds() << ", solve time, " << timer.elapsedSeconds() <<", total time, " <<  total_time.elapsedSeconds() <<  ", Expansion, " << env_1.num_expand << ", generation, " << env_1.num_generated << ",num_action," << state_game.num_apply_action <<std::endl;    
          else std::cout << filename <<  ", not success, ,"<< env.is_roll_fall << ", ,start, " << startX << ", " << startY << ", goal, " << goalX <<", " << goalY << ", memory, " << r_usage.ru_maxrss  << ",preprocess time 1, "<< preprocess.elapsedSeconds() << ", preprocess2, " << preprocess2.elapsedSeconds() << ", solve time, " << timer.elapsedSeconds() <<", total time, " <<  total_time.elapsedSeconds() << ", Expansion, " << env_1.num_expand << ", generation, " << env_1.num_generated << ",num_action," << state_game.num_apply_action <<std::endl;    
        }else{
          std::cout << filename <<  ", not success, ,"<< env.is_roll_fall << ", ,start, " << startX << ", " << startY << ", goal, " << goalX <<", " << goalY << ", memory, " << r_usage.ru_maxrss  << ",preprocess time 1, "<< preprocess.elapsedSeconds() << ", preprocess2, " << preprocess2.elapsedSeconds()<< ",preprocess time, "<< preprocess.elapsedSeconds() << ""<< ", solve time, " << timer.elapsedSeconds() <<", total time, " <<  total_time.elapsedSeconds() << ", Expansion, " << env_1.num_expand << ", generation, " << env_1.num_generated << ",num_action," << state_game.num_apply_action <<std::endl;    
