...
/*    std::vector<std::vector<bool>> flag_curr_i;
    std::vector<std::vector<bool>> flag_next_i;
    std::vector<std::vector<bool>> flag_curr_w;
	std::vector<std::vector<bool>> flag_next_w;*/
